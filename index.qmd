...
<div class="page">
  ...
  <div class="side">
    <div class="intro">
      ...
      <h1>I&rsquo;m Sam <span class="accent">Fo</span>.</h1>
      <p>I&rsquo;m passionate about incorporating data into everyday life. Over on the right are a few things I&rsquo;ve built because I wanted to know the answer &mdash; click through to try them live.</p>
  ...
  <article class="featured">
    <div class="featured-content">
      ...
      <p class="featured-desc">
        I used to keep pet snakes, so I built a classifier that identifies the different morphs
        a ball python carries from a photo. Snakes are incredibly cute and beautiful!
      </p>
      <div class="meta-row">
        <span class="tag">PyTorch</span>
        <span class="tag">fastai</span>
  ...
  <div class="projects">
    ...
    <a class="project-row" href="https://dsci-532-2024-9-solar-savers.onrender.com/" target="_blank" rel="noopener">
      ...
      <div class="row-body">
        ...
        <p class="row-desc">I built this while figuring out whether solar panels were worth it for my old family house &mdash; handy if you live somewhere sunny like the Prairies.</p>
        <div class="row-meta">
