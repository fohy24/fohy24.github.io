...
<div class="page">
  ...
  <div class="projects">
    ...
    <a class="project-row" href="https://fohy24.github.io/mr-right/" target="_blank" rel="noopener">
      <div class="row-thumb"><img src="images/thumbnail3.png" alt="mr-right dashboard"></div>
      <div class="row-body">
        <div class="row-eyebrow">Statistical Toy</div>
        <h3 class="row-title">Dream Partner Calculator</h3>
